...
L_sn123_all = np.array([40.9, 46.2, 44.2, 1.1, 53.5, 1.8, 51.7, 50.8, 64.0,
                        61.4, 50.0, 32.7, 32.5, 32.9, 20.6, 18.5, 1.7, 1.0,
...
O_2_all     = np.array([50.0, 38.6, 41.9, 97.9, 27.5, 98.9, 34.4, 33.9, 14.3,
                        0.0, 11.3, 47.3, 46, 41.4, 63.2, 38, 89.7, 92.9,
...
# Отрисовка
ax_L_abs.scatter(L_sn123_all[:9], L_2_all[:9], c='red', label='My Exp')
ax_L_abs.scatter(L_sn123_all[9:18], L_2_all[9:18], c='green', marker='s', label='Others')
ax_L_abs.scatter(L_sn123_all[18:], L_2_all[18:], c='blue', marker='s', label='Others')
...
ax_L_ef.scatter(L_sn123_all[:9], EF_L_all[:9], c='red')
ax_L_ef.scatter(L_sn123_all[9:18], EF_L_all[9:18], c='green')
ax_L_ef.scatter(L_sn123_all[18:], EF_L_all[18:], c='blue', marker='s')
...
# --- 5. Виджеты ---
# Добавлен параметр valstep=0.01 для всех слайдеров
s_AL = Slider(plt.axes([0.15, 0.30, 0.3, 0.015]), 'Lin Hald A', 0, 500, valinit=best_h[0], valstep=0.01)
s_BL = Slider(plt.axes([0.15, 0.28, 0.3, 0.015]), 'Lin Hald B', 1, 200, valinit=best_h[1], valstep=0.01)
s_CL = Slider(plt.axes([0.15, 0.26, 0.3, 0.015]), 'Lin Hald C', 0.1, 500, valinit=best_h[2], valstep=0.01)
s_AL_MM = Slider(plt.axes([0.15, 0.22, 0.3, 0.015]), 'Lin MM A', 0.1, 10, valinit=best_mm[0], color='green', valstep=0.01)
s_BL_MM = Slider(plt.axes([0.15, 0.20, 0.3, 0.015]), 'Lin MM B', 0.0, 200, valinit=best_mm[1], color='green', valstep=0.001)
