...
# ==========================================
# 3. ПОСТРОЕНИЕ ГРАФИКОВ (Только верхние 2)
# ==========================================

# Изменили размер сетки на 1 строку и 2 столбца
...
for y_data, title, ax in plot_configs:
    ...
    for i, name in enumerate(samples):
        ax.annotate(name, (sn123[i], y_data[i]), xytext=(6, 3), textcoords='offset points', fontsize=9, alpha=0.8, zorder=4)

    combined_max = max(max(sn123), max(y_data))
