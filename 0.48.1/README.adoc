...
image:https://img.shields.io/github/actions/workflow/status/ippras/utca/rust.yml?logo=github&label=Rust[Rust, link=https://github.com/ippras/utca/actions/workflows/rust.yml]
image:https://img.shields.io/github/actions/workflow/status/ippras/utca/pages.yml?logo=github&label=Github Pages[Github Pages, link=https://github.com/ippras/utca/actions/workflows/pages.yml]
